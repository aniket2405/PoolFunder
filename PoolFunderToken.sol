...
contract PoolFunderToken is Ownable, IERC20 {
    ...
    string public constant _name = "PoolFunderToken";
    string public constant _symbol = "PFT";
    ...
    // burning tokens while transferring from one address to another.
    ...
    // mint tokens fro the burn address to the address given
    ...
    // burn tokens from the entire totalSupply
